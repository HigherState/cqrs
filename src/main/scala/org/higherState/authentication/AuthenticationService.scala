...
import org.higherState.cqrs.{Service, Dispatcher, Iter}

class AuthenticationService[Out[+_]](dispatcher:Dispatcher[Out, AuthenticationCommand, AuthenticationQueryParameters]) extends Service[Out] {
